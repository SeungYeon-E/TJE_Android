...
public class MainActivity extends AppCompatActivity {
    ...
    private void addListener(){
        ...
        selectBtn = findViewById(R.id.btn_selectA);
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()){
                ...
                case R.id.btn_update:
                    ...
                    intent.putExtra("macIP", tempIp);
                    startActivity(intent);
                    Toast.makeText(MainActivity.this, "검색후 선택을 짦게 누르면 수정화면으로 이동합니다.", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.btn_delete:
                    intent = new Intent(MainActivity.this, SelectAllActivity.class);
                    intent.putExtra("macIP", tempIp);
                    startActivity(intent);
                    Toast.makeText(MainActivity.this, "검색후 선택을 길게 누르면 삭제화면으로 이동합니다.", Toast.LENGTH_SHORT).show();
                    break;
