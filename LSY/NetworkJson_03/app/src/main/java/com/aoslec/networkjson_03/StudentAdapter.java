...
//    public void onItemSwipe(int position) { items.remove(position); notifyItemRemoved(position); }
    ...
    private String htmlData(String image){
        String content =
                "<?xml version=\"1.0\" encoding=\"UTF-8\" ?>"+
                        ...
                        "<head><body>"+
                        "<img src=\"http://172.30.1.8:8080/test/";
    ...
    public boolean onItemMove(int from_position, int to_position) {
        //이동할 객체 저장
        JsonStudent person = data.get(from_position);
        //이동할 객체 삭제
